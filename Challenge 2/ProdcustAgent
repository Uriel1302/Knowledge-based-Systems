...
public class ProducstAgent extends Agent{
    ...
    private class TellBehaviour extends Behaviour {
        ...
        public void action() {
            ...
            try {
                clips.clear();
                clips.load("src/clips/prodcust/templates.clp");
                clips.load("src/clips/prodcust/facts.clp");
                clips.load("src/clips/prodcust/rules.clp");
                clips.reset();
                clips.eval("(facts)");
            } catch (Exception e) {
            }
